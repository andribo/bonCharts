define(['backbone'], function (Backbone) {
  ...
  model.ChartSettingsCollection = Backbone.Collection.extend({
    ...
    toC3: function () {
      ...
      })(getPropertyByName('tooltip_format_title', models), c3config.axis.x.type == 'timeseries', getPropertyByName('axis_x_tick_value_format', models)); //c3config.axis.x.type == 'timeseries'
...
// function formatTooltip (format, name, value, ratio, id, index) {
//   if (!format) {
//     return '';
//   }
...
// function formatTooltipName (format, ratioFormat) {
//   return function (name, ratio, id, index) {
//     formatTooltip(format, name, value, d3.format(ratioFormat)(ratio), id, index);
//   };
// }

// function formatTooltipValue (format, valueFormat, ratioFormat) {
//   return function (name, ratio, id, index) {
//     formatTooltip(format, name, d3.format(valueFormat)(value), d3.format(ratioFormat)(ratio), id, index);
//   };
// }

//  case 'tooltip_format_name':
//               value = formatTooltipName(value, model.tooltip_format_ratio_format);
//               break;
//             case 'tooltip_format_value':
//               c3config.tooltip.format.value = formatTooltipValue(model[prop], model['tooltip_format_value_format'], model['tooltip_format_ratio_format']);
//               break;

//               formatMap {
//                 tooltip_format_ratio_format: formatTooltipValue
//               }